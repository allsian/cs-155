...
best_rated_heap = MovieHeap(10)
for movie_id in movie_ratings.keys():
    if len(movie_ratings[movie_id]) > 100:
        best_rated_heap.push(movie_id, np.mean(movie_ratings[movie_id]))

most_popular_ids = best_rated_heap.get_all()
